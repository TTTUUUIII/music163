...
NEJ.P = function(JU2x) {
    if (!JU2x || !JU2x.length)
        return null;
    var bdq6k = window;
    for (var a = JU2x.split("."), l = a.length, i = a[0] == "window" ? 1 : 0; i < l; bdq6k = bdq6k[a[i]] = bdq6k[a[i]] || {},
    i++)
        ;
    return bdq6k
}
...
var FB8t = function(i1x, t1x) {
    try {
        ...
        return bd1x.toString.call(i1x).toLowerCase() == "[object " + t1x + "]"
    } catch (e) {
        return !1
    }
};
...
Rj3x.md = ["色", "流感", "这边", "弱", "嘴唇", "亲", "开心", "呲牙", "憨笑", "猫", "皱眉", "幽灵", "蛋糕", "发怒", "大哭", "兔子", "星星", "钟情", "牵手", "公鸡", "爱意", "禁止", "狗", "亲亲", "叉", "礼物", "晕", "呆", "生病", "钻石", "拜", "怒", "示爱", "汗", "小鸡", "痛苦", "撇嘴", "惶恐", "口罩", "吐舌", "心碎", "生气", "可爱", "鬼脸", "跳舞", "男孩", "奸笑", "猪", "圈", "便便", "外星", "圣诞"]
j1x.bh1x = function(k1x, cH2x, O1x) {
    if (!k1x || !k1x.length || !j1x.gX3x(cH2x))
        return this;
    if (!!k1x.forEach) {
        k1x.forEach(cH2x, O1x);
        return this
    }
    for (var i = 0, l = k1x.length; i < l; i++)
        cH2x.call(O1x, k1x[i], i, k1x);
    return this
};
...
j1x.gX3x = function(i1x) {
    return FB8t(i1x, "function")
};

var bvj1x = function(chU3x) {
    var m1x = [];
    j1x.bh1x(chU3x, function(chO3x) {
        m1x.push(Rj3x.emj[chO3x])
    });
    return m1x.join("")
};
